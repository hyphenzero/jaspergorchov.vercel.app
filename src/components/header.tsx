  ...
  return (
    <>
      <Container className="z-50">
        <Navbar className="inset-x-0">
          <Link href="/" aria-label="Home">
            <Logo className="size-10 sm:size-8" />
          </Link>
          <a
            href="https://tailwindcss.com/blog/introducing-catalyst"
            className="group -my-2 ml-6 hidden items-center gap-2 rounded-full px-3 py-2 text-xs text-zinc-950 ring-1 ring-inset ring-black/[0.08] hover:bg-white/5 hover:ring-black/[0.13] sm:flex md:ml-8 lg:hidden min-[1300px]:flex dark:text-white dark:ring-white/[0.08] dark:hover:bg-zinc-950/5 dark:hover:ring-white/[0.13]"
          >
            <svg className="h-4 w-4 fill-sky-500 dark:fill-sky-400" viewBox="0 0 24 24">
              <path
                fillRule="evenodd"
            ...
            <svg width="2" height="2" aria-hidden="true" className="fill-zinc-950 dark:fill-white">
            ...
            <svg
              viewBox="0 0 5 8"
              className="h-2 w-[5px] fill-black/30 group-hover:fill-black/60 dark:fill-white/30 dark:group-hover:fill-white/60"
              fillRule="evenodd"
              clipRule="evenodd"
              aria-hidden="true"
            >
